...
# @raycast.title Set Status to Lunch
# @raycast.mode silent
...
STATUS_TEXT="Lunch Break - Be Right Back"
...
STATUS_EXPIRATION_IN_MINUTES="60"
...
if [[ "$RESPONSE" =~ "error" ]]
then
  # echo "{ 'profile': { 'status_text': '$STATUS_TEXT', 'status_emoji': '$STATUS_EMOJI', 'status_expiration': $STATUS_EXPIRATION } }"
#  echo "$RESPONSE"
